...
<template>
    <HorizontalContentTileCollection v-for="(c, index) in unpinnedNewestContentByCategory.tagged.value" :key="c.tag._id"
        :contentDocs="c.content" :title="c.tag.title" :summary="c.tag.summary" class="pb-1"
