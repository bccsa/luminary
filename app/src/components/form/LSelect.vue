...
<template>
    <div :class="$attrs['class']" :style="$attrs['style'] as StyleValue">
        ...
        <div class="relative">
            ...
            <select
                v-model="model"
                class="block h-full w-full justify-items-center rounded-md border-0 px-1 py-2 text-sm font-semibold text-zinc-900 shadow-sm ring-1 ring-inset hover:bg-zinc-50 focus:ring-2 disabled:bg-zinc-100 disabled:text-zinc-500 disabled:ring-zinc-200 sm:text-sm sm:leading-6"
