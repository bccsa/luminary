            ...
            <div class="relative">
                ...
                >
                    ...
                    <template #imageOverlay>
                        ...
                        <div
                            v-else
                            class="flex h-full max-h-full w-full max-w-full items-center justify-center overflow-clip bg-linear-to-t from-black/50 to-black/20 text-sm font-semibold"
                        >
