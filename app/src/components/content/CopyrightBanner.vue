...
<template>
    <div>
        <div
            ...
            class="text-md prose prose-zinc max-w-full border-t-2 border-t-zinc-100/25 bg-zinc-100/50 px-4 py-2 dark:prose-invert dark:border-t-slate-700/50 dark:bg-slate-800/50"
        ></div>
    </div>
</template>
