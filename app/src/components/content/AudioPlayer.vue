...
const getVolumeFromEvent = (e: MouseEvent | TouchEvent) => {
    ...
    // Invert the percentage for vertical slider (top = 100%, bottom = 0%)
...
const handleKeyDown = (event: KeyboardEvent) => {
    ...
    switch (event.key) {
        ...
        case "/":
            event.preventDefault();
            // Only show help modal on desktop
...
<template>
    <div class="">
        ...
        <transition name="slide-up">
            <div
                v-show="isExpanded"
                class="expanded-player fixed bottom-[70px] left-0 right-0 z-50 flex max-h-[80vh] w-full flex-col justify-items-end overflow-auto bg-amber-50 scrollbar-hide dark:bg-slate-700 lg:bottom-5 lg:left-auto lg:right-5 lg:max-h-none lg:w-80 lg:rounded-2xl lg:shadow-2xl lg:shadow-black/20"
                :style="{
        ...
        <div
            v-if="!isExpanded"
            @click="toggleExpand"
            class="fixed bottom-[70px] left-0 right-0 z-50 flex w-full cursor-pointer items-center justify-between bg-amber-50 p-2 dark:bg-slate-700 lg:bottom-5 lg:left-auto lg:right-5 lg:w-80 lg:rounded-lg lg:shadow-lg"
        >
        ...
        <div
            v-if="showHelpModal"
            class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 lg:flex"
        ...
        >
            ...
            >
                ...
                <div class="space-y-2.5 text-sm">
                    <div
                        class="rounded-lg border border-zinc-200 bg-zinc-50/50 p-2.5 dark:border-zinc-700 dark:bg-zinc-900/50"
                    >
                        <h4 class="mb-2 text-xs font-semibold text-zinc-800 dark:text-zinc-200">
                            Playback
                        </h4>
