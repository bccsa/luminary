...
| `clientRuntime.ts`             | `initSsgClient()` boots the data layer on the **browser client** after hydration (`init()` + language sync); `startSsgContentSync()` applies the content sync policy once auth resolves (ADR 0020).                                                                                                                                                                                                                                                                                                                     | browser          |
