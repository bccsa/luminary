...
export const mockLanguageDtoEng: LanguageDto = {
    ...
    translations: {
        ...
        "search.score": "Score",
        "search.indexed": "Indexed {count} documents",
        "search.results": "Search",
        "search.resultsFor": "Results for",
        "search.useSearchModal": "Use the search (Cmd+K) or add ?q=... to the URL.",
        "search.aiExplanation": "Explanation",
        "search.aiLoading": "Loading explanation...",
        "search.aiUnavailable": "Explanation unavailable.",
        "search.contentResults": "Content",
...
export const mockLanguageDtoFra: LanguageDto = {
    ...
    translations: {
        ...
        "search.score": "Score",
        "search.indexed": "{count} documents indexés",
        "search.results": "Recherche",
        "search.resultsFor": "Résultats pour",
        "search.useSearchModal": "Utilisez la recherche (Cmd+K) ou ajoutez ?q=... à l'URL.",
        "search.aiExplanation": "Explication",
        "search.aiLoading": "Chargement de l'explication...",
        "search.aiUnavailable": "Explication indisponible.",
        "search.contentResults": "Contenu",
        "search.seeAllResults": "Voir tous les résultats",
...
export const mockLanguageDtoSwa: LanguageDto = {
    ...
    translations: {
        ...
        "search.score": "Alama",
        "search.indexed": "Nyaraka {count} zimewekwa",
        "search.results": "Tafuta",
        "search.resultsFor": "Matokeo ya",
        "search.useSearchModal": "Tumia tafuta (Cmd+K) au ongeza ?q=... kwenye URL.",
        "search.aiExplanation": "Maelezo",
        "search.aiLoading": "Inapakia maelezo...",
        "search.aiUnavailable": "Maelezo hayapatikani.",
        "search.contentResults": "Maudhui",
        "search.seeAllResults": "Tazama matokeo yote",
        "title.search": "Tafuta",
        "menu.home": "Nyumbani",
