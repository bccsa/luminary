...
export const mockLanguageDtoEng: LanguageDto = {
    ...
    translations: {
        ...
        "search.minCharsShort": "At least 3 characters",
        "search.hint": "Search by title, summary, or content",
        "search.shortcut": "⌘K · Ctrl+K to open",
...
export const mockLanguageDtoFra: LanguageDto = {
    ...
    translations: {
        ...
        "search.tryDifferent": "Essayez d'autres mots-clés",
        "search.minChars": "Saisissez au moins 3 caractères pour rechercher",
        "search.minCharsShort": "Au moins 3 caractères",
        "search.hint": "Rechercher par titre, résumé ou contenu",
        "search.shortcut": "⌘K · Ctrl+K pour ouvrir",
        "search.toClose": "pour fermer",
        "search.navigate": "pour naviguer",
        "search.select": "pour sélectionner",
        "search.resultOne": "résultat",
        "search.resultsMany": "résultats",
        "search.score": "Score",
