 ...
 * That app writes to the storage bucket itself, so there is nothing to upload,
 * migrate or delete here — the document carries a URL to a collection this API
 * never handles the bytes of.
 *
