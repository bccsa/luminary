 ...
 */
export function expandMangoSelector(selector: MongoSelectorDto): MongoSelectorDto {
    const andConditions: MongoSelectorDto[] = [];
    ...
    for (const key of Object.keys(selector)) {
        ...
        if (isCombinationOperator(key)) {
            ...
            andConditions.push({ [key]: selector[key] } as MongoSelectorDto);
        } else {
