 ...
 * authorised request per parent. See ADR 0019
...
export class SidecarController {
    ...
    async getSidecar(
        ...
        // Same identity used by both limiters (ADR 0019) — read bounds
        ...
        // be used to probe which parent IDs exist or which groups a caller lacks (ADR 0019).
