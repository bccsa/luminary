...
export const mockAudioPlaylistContent: Content = {
    ...
    text: '{"ops":[{"insert":"An audio playlist."}]}',
    publishDate: DateTime.fromObject({ year: 2024, month: 1, day: 1 }),
};
