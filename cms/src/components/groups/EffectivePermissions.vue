    ...
    >
        <template #content>
            <div class="flex items-center justify-between">
                <div
                    :class="[
                        'flex-shrink-0 whitespace-nowrap pl-3 text-sm text-zinc-500 dark:text-zinc-400',
                ...
                <div
                    ...
                    class="mr-2 text-xs italic text-zinc-400 dark:text-zinc-500"
                >
                ...
                <div class="mx-1 flex gap-1 overflow-x-auto scrollbar-hide">
                    <template v-for="(permissions, type) in entry.permissionsByDocType" :key="type">
                        <div
                            ...
                            class="flex flex-shrink-0 items-baseline rounded-md border border-zinc-100 bg-slate-400 bg-opacity-10 px-2 py-0.5 text-xs font-medium text-zinc-400 dark:border-slate-700 dark:bg-slate-700/40 dark:text-zinc-400"
                        >
