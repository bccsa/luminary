...
<template>
    <div class="flex-col overflow-y-auto">
        ...
        <p class="mb-2 text-xs">
            You can upload several files in different aspect ratios. The most suitable image will
            automatically be displayed based on the aspect ratio of the image element where the
            image is displayed.
        </p>
        <p class="mb-2 text-xs">
        ...
        <div
            class="mb-4 flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-6"
            @dragenter="handleDragEnter"
            @dragover="handleDragOver"
            @dragleave="handleDragLeave"
            @drop="handleDrop"
            :class="{ 'border-blue-500 bg-blue-50': isDragging }"
            style="min-height: 200px; transition: border 0.3s ease"
        >
            ...
            <input
                ...
                multiple
            />
            <p v-if="isDragging" class="mt-2 text-xs text-blue-500">Drop your files here</p>
        </div>
        ...
        <div
            ...
            "
        >
            <h3 class="mt-4 text-sm font-medium leading-6 text-zinc-900">Uploaded Image files</h3>
