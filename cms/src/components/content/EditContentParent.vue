...
<template>
    ...
    >
        ...
        <div class="mt-4 flex flex-col gap-2.5 border-t border-zinc-200 pt-3 dark:border-slate-700">
            ...
            <div v-if="docType == DocType.Post" class="flex items-center justify-between gap-2">
                <span class="text-sm text-zinc-700 dark:text-zinc-300">Author type</span>
                <LTextToggle
                    v-model="authorType"
                    leftLabel="Person"
                    leftValue="person"
