...
const states = {
    default:
        "text-gray-900 ring-gray-300 placeholder:text-gray-400 hover:ring-gray-400 focus:ring-yellow-500",
...
<template>
    <div :class="$attrs['class']" :style="$attrs['style'] as StyleValue">
        ...
        <div class="relative mt-2 flex rounded-md shadow-sm">
            ...
            <input
                class="block w-full border-0 ring-1 ring-inset focus:ring-2 focus:ring-inset disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 sm:text-sm sm:leading-6"
                :class="[
                    sizes[size],
                    states[state],
                    {
