    ...
    >
        <div class="flex justify-between">
            <div class="flex items-center gap-1">
                <component :is="props.icon" class="h-5 w-5 text-zinc-400" v-if="props.icon" />
        ...
        <LModal :heading="label ? label : ''" v-bind:isVisible="showEditModal">
            <div
            ...
            <div
                ...
                class="absolute z-10 mt-1 max-h-48 overflow-y-auto rounded-md border-[1px] border-zinc-100 bg-white shadow-md"
