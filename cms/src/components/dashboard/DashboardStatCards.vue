...
<template>
    <div class="grid grid-cols-2 gap-2 max-lg:p-4 max-lg:pb-0 lg:flex">
        <RouterLink
            ...
            class="group rounded-lg border border-zinc-200 bg-white px-4 py-3 transition-colors hover:border-zinc-300 lg:flex-1"
        >
        ...
        <div class="rounded-lg border border-zinc-200 bg-white px-4 py-3 lg:flex-1">
            <div class="flex items-center gap-2 text-zinc-500">
