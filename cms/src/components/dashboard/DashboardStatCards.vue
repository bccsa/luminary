...
<template>
    <div class="grid grid-cols-2 gap-2 max-lg:p-4 max-lg:pb-0 lg:flex">
        ...
        <div
            class="transparent group rounded-lg border border-t-4 border-zinc-400 bg-white p-5 px-3 py-2 shadow-sm transition-colors duration-200 hover:border-green-600 dark:bg-slate-800 dark:hover:border-green-600 lg:flex-1"
        >
            <div class="flex items-center gap-2 dark:text-zinc-100">
        ...
        <div
            class="transparent group rounded-lg border border-t-4 border-zinc-400 bg-white p-5 px-3 py-2 shadow-sm transition-colors duration-200 hover:border-purple-300 dark:bg-slate-800 dark:hover:border-purple-300 lg:flex-1"
        >
            <div class="flex items-center gap-2 dark:text-zinc-100">
