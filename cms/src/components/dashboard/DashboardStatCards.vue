...
<template>
    <div class="grid grid-cols-2 gap-2 max-lg:p-4 max-lg:pb-0 lg:flex">
        <RouterLink
            ...
            class="group rounded-lg border border-zinc-500 bg-slate-600 px-1.5 py-3 transition-colors hover:border-zinc-300 lg:flex-1"
        >
            <div class="flex items-center gap-2 text-zinc-100">
                <DocumentDuplicateIcon class="h-4 w-4" />
                <span class="text-xs font-medium uppercase tracking-wide">Posts</span>
            </div>
            <p class="mt-0.5 text-xl font-semibold leading-tight text-yellow-400">
                {{ posts.length }}
            </p>
        ...
        <div class="rounded-lg border border-zinc-500 bg-slate-600 px-1.5 py-3 lg:flex-1">
            <div class="flex items-center gap-2 text-zinc-100">
