...
<template>
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div class="flex flex-col lg:flex-row lg:items-baseline lg:gap-2">
            ...
            <h2 class="text-lg font-semibold text-zinc-800 dark:text-yellow-400">{{ userName }}</h2>
            <p class="text-xs text-zinc-800 dark:text-zinc-300">Here's what's happening today</p>
        </div>
