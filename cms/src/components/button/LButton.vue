...
const buttonClasses = cva({
    ...
    variants: {
        variant: {
            primary:
                "bg-zinc-700 ring-1 shadow-sm text-white ring-zinc-900/60 hover:bg-zinc-800/90 active:bg-zinc-800/80 dark:bg-zinc-300 dark:text-zinc-900 dark:ring-white/10 dark:hover:bg-zinc-300/80 dark:active:bg-zinc-300 disabled:bg-zinc-300 disabled:text-zinc-100 dark:disabled:bg-zinc-800 dark:disabled:text-zinc-600",
            secondary:
