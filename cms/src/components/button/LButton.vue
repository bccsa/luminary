...
const buttonClasses = cva({
    ...
    variants: {
        variant: {
            ...
            custom: "bg-white ring-1 shadow-sm ring-zinc-300 hover:bg-black hover:text-white active:bg-black active:text-white disabled:bg-zinc-100 disabled:text-zinc-500",
        },
        size: {
            sm: "px-2 py-1.5",
            base: "px-3 py-2",
