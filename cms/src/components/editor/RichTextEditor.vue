...
const editor = useEditor({
    ...
    editorProps: {
        attributes: {
            class: "prose sm:min-h-[calc(100vh-12rem)] sm:max-h-[calc(100vh-12rem)] max-h-[calc(100vh-30rem)] prose-zinc lg:prose-sm max-w-none p-3 ring-1 ring-inset border-0 focus:ring-2 focus:ring-inset focus:outline-none rounded-md ring-zinc-300 hover:ring-zinc-400 focus:ring-zinc-950",
        },
