...
export const CMS_DOCS_INDEX =
    "type, parentId, updatedTimeUtc, language, [type+tagType], [type+docType], [type+language], slug, [type+slug], title, [type+parentType+language], [type+parentTagType], [type+parentId], [type+_id]";
