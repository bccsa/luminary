...
onBeforeMount(async () => {
    ...
    try {
        const _api = api({
            ...
            token,
            docTypes: [
                { type: DocType.Tag, contentOnly: false },
                { type: DocType.Post, contentOnly: false },
                { type: DocType.Group, contentOnly: false },
                { type: DocType.Redirect, contentOnly: false },
                { type: DocType.Image, contentOnly: false },
                { type: DocType.Media, contentOnly: false },
                { type: DocType.MediaDownload, contentOnly: false },
