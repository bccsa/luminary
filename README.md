...
2. **Start**: Run `docker compose -f .devcontainer/docker-compose.yml up --build -d` in your terminal.
3. **Develop**: Open this folder in VS Code and click "Reopen in Container" when prompted.

See [Docker Setup Guide](./.devcontainer/docker-setup.md) for full details.
