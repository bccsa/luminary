...
class Database extends Dexie {
    ...
    constructor() {
        ...
        this.version(9).stores({
            docs: "_id, type, parentId, updatedTimeUtc, slug, language, docType, [parentId+type], [parentId+parentType], [type+tagType], publishDate, expiryDate, [type+language+parentType+status], [type+language+parentPinned], title, parentPinned",
